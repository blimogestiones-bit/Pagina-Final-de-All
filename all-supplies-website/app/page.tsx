          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection animation="fade-up" delay={200}>
              <p className="text-xl text-white mb-8 leading-relaxed drop-shadow-md">
                ...
                divisiones clave:
                <span className="font-semibold text-white"> Energía y Tecnología</span>,
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="text-center max-w-2xl">
              ...
              <p className="text-text-secondary">
                Empresa multinacional especializada en Energía y Tecnología, Servicios de Procura y Gestión Financiera
                Internacional
              </p>
            </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Empresa multinacional especializada en soluciones estratégicas para Energía y Tecnología, Servicios de Procura y Gestión Financiera Internacional",
